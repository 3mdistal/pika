...
describe('template command', () => {
  ...
  describe('template list', () => {
    ...
    it('should show message when no templates found', async () => {
      ...
      await rm(join(vaultDir, '.ovault/templates'), { recursive: true, force: true });
  ...
  describe('template validate', () => {
    ...
    it('should detect invalid type path', async () => {
      ...
      await writeFile(
        join(vaultDir, '.ovault/templates/idea', 'invalid.md'),
        `---
type: template
...
`
    ...
    it('should detect invalid default values', async () => {
      ...
      await writeFile(
        join(vaultDir, '.ovault/templates/idea', 'bad-enum.md'),
        `---
type: template
template-for: idea
defaults:
...
`
    ...
    it('should suggest typo corrections', async () => {
      ...
      await writeFile(
        join(vaultDir, '.ovault/templates/idea', 'typo.md'),
        `---
type: template
template-for: idea
defaults:
...
`
  ...
  describe('template new (JSON mode)', () => {
    it('should create a template from JSON', async () => {
      ...
      const templatePath = join(vaultDir, '.ovault/templates/idea', 'quick-idea.md');
